  ...
  function createStickyCtaBar() {
    ...
    bar.innerHTML = `
      <div class="sticky-cta-inner">
        ...
        <a href="https://lin.ee/pFsiKeq" class="sticky-cta-btn" target="_blank" rel="noopener"
           onclick="if(typeof gtag_report_conversion==='function'){gtag_report_conversion('https://lin.ee/pFsiKeq');} return true;">
